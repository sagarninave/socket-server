...
exports.changePasswordEmailTemplate = exports.resetPasswordEmailTemplate = exports.verifyEmailTemplate = exports.loginTemplate = exports.signupTemplate = exports.templateFrame = void 0;
const templateFrame = (content) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
exports.templateFrame = templateFrame;
const signupTemplate = (name) => {
    return (0, exports.templateFrame)(`
    <body>
      <div class="container">
...
const loginTemplate = (emailData) => {
    return (0, exports.templateFrame)(`
    <body>
      <div class="container">
        <h1>Recent Login Notification</h1>
        <p>Dear ${emailData === null || emailData === void 0 ? void 0 : emailData.name},</p>
...
const changePasswordEmailTemplate = (name) => {
    return (0, exports.templateFrame)(`
    <body>
      <div class="container">
...
exports.changePasswordEmailTemplate = changePasswordEmailTemplate;
